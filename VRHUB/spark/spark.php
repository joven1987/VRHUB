		...
		<div class="main main-raised" style="margin-top: -260px;"> <!--margin top decreased-->
			<div class="section section-basic" style="padding: 0"> <!--added padding-->
				<!-- <div class="page-header" style="margin: 40px 300px 20px; border-bottom: 3px solid #000000;"> -->
					<center><h2>Spark</h2></center>
				<!-- </div> -->
				<div id="directions-panel" style="position: absolute; z-index: 99; border: groove; right: 8%; top: 30%; background-color: rgba(0, 0, 0, 0.23); border-radius: 10px; max-width: 234px; min-width: 234px;"></div>
...
<script type="text/javascript">
	...
	function getMap () {
		...
		//codes for waypoints
   		...
   		//set markers
   			var markerSM = new google.maps.Marker({
				position: {lat: 10.242547, lng: 123.798016},
				map: map,
				title: 'Spark',
			...
			// markerClip.addListener('click', get360Image); //uncomment this if 360 image is available
        ...
        directionsService.route({
          ...
          destination: "10.242547, 123.798016",
          waypoints: waypts,
          ...
          if (status === 'OK') {
            ...
            summaryPanel.innerHTML = '<h3>Spark</h3>';
