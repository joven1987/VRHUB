...
<head>
	...
	<title>Mabolo Garden Flats</title>
		...
		<div class="main main-raised" style="margin-top: -260px;"> <!--margin top decreased-->
			<div class="section section-basic" style="padding: 0"> <!--added padding-->
				<!-- <div class="page-header" style="margin: 40px 300px 20px; border-bottom: 3px solid #000000;"> -->
					<center><h2>Mabolo Garden Flats</h2></center>
				<!-- </div> -->
	...
	function getMap () {
        ...
        //variables for way points
			...
			var map = new google.maps.Map(document.getElementById('container'), {
				...
				center: {lat: 10.319378, lng: 123.912979},
				mapTypeControl: true,
		...
		//codes for waypoints
   		...
   		//set markers
   			var markerMGF = new google.maps.Marker({
				position: {lat: 10.319378, lng: 123.912979},
				map: map,
			...
			markerMGF.addListener('click', get360Image); 
        ...
        directionsService.route({
          ...
          destination: "10.319378, 123.912979",
          waypoints: waypts,
          ...
          if (status === 'OK') {
            ...
            summaryPanel.innerHTML = '<h3>MGF</h3>';
