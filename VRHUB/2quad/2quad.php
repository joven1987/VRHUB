...
<body class="index-page" onLoad="window.scroll(0, 500);">
	<!-- Navbar -->
		...
		<div class="main main-raised">
			<div class="section section-basic">
				<div class="page-header" style="margin: 40px 300px 20px; border-bottom: 3px solid #000000;">
					<center><h1>2Quad Building</h1></center>
				</div>
...
<script>
	function getMap () {
			...
			marker2Quad.addListener('click', get360Image);
...
function get360Image () {
		...
		skin=new pano2vrSkin(pano);
			...
			// load the configuration when marker2Quad is clicked
