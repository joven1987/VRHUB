...
<script type="text/javascript">
	function getMap () {
		...
		//codes for waypoints
   		...
   		//set markers
   			var markerI2 = new google.maps.Marker({
				position: {lat: 10.327624, lng: 123.906751},
				map: map,
				title: 'i2',
			...
			markerI2.addListener('click', get360Image); 
        ...
        directionsService.route({
          ...
          destination: "10.327624, 123.906751",
          waypoints: waypts,
          ...
          if (status === 'OK') {
            ...
            summaryPanel.innerHTML = '<h3>i2</h3>';
