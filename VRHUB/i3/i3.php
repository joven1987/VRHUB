	...
	function getMap () {
        ...
        //variables for way points
			...
			var map = new google.maps.Map(document.getElementById('container'), {
				...
				center: {lat: 10.327910, lng: 123.907005},
				mapTypeControl: true,
		...
		//codes for waypoints
   		...
   		//set markers
   			var markerI3 = new google.maps.Marker({
				position: {lat: 10.327910, lng: 123.907005},
				map: map,
				title: 'i3',
			...
			markerI3.addListener('click', get360Image); 
        ...
        directionsService.route({
          ...
          destination: "10.327910, 123.907005",
          waypoints: waypts,
          ...
          if (status === 'OK') {
            ...
            summaryPanel.innerHTML = '<h3>i3</h3>';
